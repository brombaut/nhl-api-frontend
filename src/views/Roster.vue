      ...
      <table :style="tableStyle">
        ...
        <tbody>
          <tr
            ...
            @click="handlePlayerRowClick(rowData.personId)"
          >
            ...
            <td :style="tableDataCellStyle">
              {{ buildPlayerBirthPlaceString(rowData) }}
            </td>
          </tr>
        </tbody>
      </table>
...
export default class Roster extends Vue {
  ...
  handlePlayerRowClick(playerId: number) {
    PlayersModule.selectPlayerById(playerId);
  }
